...
const ValueSec = () => {
    return (
        <div className='md:flex lg:flex justify-center items-center lg:w-5/6 md:w-4/6 w-20 lg:mx-auto md:mx-auto lg:my-4'>
            ...
            className="card w-96 bg-neutral text-neutral-content lg:w-58 w-80 lg:m-3 mx-10 my-6 shadow-md cursor-pointer hover:shadow-2xl ">
            ...
            data-aos-easing="ease-in-out"
            className="card w-96 bg-neutral text-neutral-content lg:w-58 w-80 lg:m-3 mx-10 my-6 shadow-2xl cursor-pointer border-t-4 border-t-primary hover:shadow-2xl">
                <div className="card-body items-center text-center text-secondary">
